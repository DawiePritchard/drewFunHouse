...
/*============================== HEALTH/DAMAGE ========================================= */
  ...
  {
    if((energy < 190) && (health == MAX_HEALTH))
    {
      HEon = false;
    }
    ...
    if(HEon)
    {
      float ratio1 = health/MAX_HEALTH;
      float ratio2 = ratio1 * 2.900223f;
      HealthImg.rectTransform.localScale = new Vector3(ratio2, 0.325f, 1);
      HealthText.text = "Health: " + (ratio1*100).ToString("0") + "%";
    }
